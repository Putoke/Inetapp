 ...
 */
public class RemoveScheduleTask extends AsyncTask<Void, Void, Boolean>{

    private String name;

    public RemoveScheduleTask(String name) {
        this.name = name;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            HttpPost request = new HttpPost(Misc.ServerAddress + "/schedules/remove");
