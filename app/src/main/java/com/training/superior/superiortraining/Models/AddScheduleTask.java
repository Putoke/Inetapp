...
public class AddScheduleTask extends AsyncTask<Void, Void, Boolean> {
    ...
    private String name, workout, day;

    public AddScheduleTask(String name, String workout, String day) {
        this.name = name;
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            sendJson.put("Workout", workout);
            sendJson.put("Day", day);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        try {
            HttpPost request = new HttpPost(Misc.ServerAddress + "/schedules/add");
