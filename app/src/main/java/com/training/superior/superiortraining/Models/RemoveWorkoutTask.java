 ...
 */
public class RemoveWorkoutTask extends AsyncTask<Void, Void, Boolean> {

    private String name;

    public RemoveWorkoutTask(String name) {
        this.name = name;
    }
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            HttpPost request = new HttpPost(Misc.ServerAddress + "/workouts/remove");
